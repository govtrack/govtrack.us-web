...
factors = {('bill', False): {'bill_type': 'bill',
                   ...
                   'factors': {u'committee_HSAG': {'count': 28,
                               ...
                               u'committee_SSGA': {'count': 42,
                                                   ...
                                                   'regression_beta': 0.7229384208868439,
                               ...
                               'companion_bipartisan': {'count': 78,
                                                        ...
                                                        'regression_beta': 0.86401801717839943,
                                                        'success_rate': 41.02564102564103},
                               'cosponsor_rankingmember': {'count': 177,
                                                           'description': 'A cosponsor is a relevant committee ranking member.',
                                                           'regression_beta': 0.66704355535250193,
                                                           'success_rate': 33.898305084745765},
                               'cosponsors_bipartisan': {'count': 137,
                                                         'description': 'Sponsor is in majority party and 1/3rd+ of cosponsors are in minority party.',
                                                         'regression_beta': 0.74661393074217208,
                                                         'success_rate': 42.33576642335766},
                               'introduced_last90days': {'count': 32,
                                                         'description': 'Introduced in the last 90 days of the Congress (incl. companion bills).',
                                                         'regression_beta': 1.1786501928594033,
                                                         'success_rate': 46.875},
                               'sponsor_committee_member_majority': {'count': 649,
                                                                     'description': 'Sponsor is on a relevant committee & in majority party.',
                                                                     'regression_beta': -0.49817580134588241,
                                                                     'success_rate': 17.719568567026194},
                               'sponsor_leader_majority': {'count': 121,
                                                           'description': 'Sponsor has a high leadership score (majority party).',
                                                           'regression_beta': -0.60441679474493759,
                                                           'success_rate': 14.87603305785124},
                               u'startswith:To designate the facility of the United States Postal': {'count': 49,
                                                                                                     ...
                                                                                                     'regression_beta': 2.9762966324113047,
                                                                                                     'success_rate': 83.6734693877551}},
                   'is_introduced_model': False,
                   'regression_beta': [-1.5406807729171021,
                                       1.0972382526227087,
                                       0.76624539038593709,
                                       1.1786501928594033,
                                       -0.49817580134588241,
                   ...
                   'regression_predictors_map': {u'committee_HSAG': 9,
                                                 ...
                                                 'sponsor_leader_majority': 7,
                                                 u'startswith:To designate the facility of the United States Postal': 10},
 ...
 ('jr', False): {'bill_type': 'jr',
                 ...
                 'factors': {'companion': {'count': 19,
                                           'description': 'Has a companion bill in the other chamber.',
                                           'regression_beta': -1.4543604114345672,
                                           'success_rate': 5.2631578947368425},
                             'companion__cosponsor_committeemember_6+': {'count': 16,
                                                                         'description': 'On a companion bill: 6+ cosponsors are on a relevant committee.',
                                                                         'regression_beta': -1.4543604114345674,
                                                                         'success_rate': 6.25}},
                 'is_introduced_model': False,
                 'regression_beta': [0.20067069546215136,
                                     -1.4543604114345674,
                                     -1.4543604114345672],
