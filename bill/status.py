...
class BillStatus(enum.Enum):
    ...
    passed_simpleres = enum.Item(6, 'Passed (Simple Resolution)', xml_code='PASSED:SIMPLERES')
    passed_constamend = enum.Item(7, 'Passed (Constitutional Amendment)', xml_code='PASSED:CONSTAMEND')
    passed_concurrentres = enum.Item(8, 'Passed (Concurrent Resolution)', xml_code='PASSED:CONCURRENTRES')
    ...
    override_pass_over_house = enum.Item(21, 'House Overrides Veto', xml_code='OVERRIDE_PASS_OVER:HOUSE')
    override_pass_over_senate = enum.Item(22, 'Senate Overrides Veto', xml_code='OVERRIDE_PASS_OVER:SENATE')
