...
class BillStatus(enum.Enum):
    ...
    passed_constamend = enum.Item(7, 'Agreed To (Constitutional Amendment)', xml_code='PASSED:CONSTAMEND', search_help_text="The resolution proposing a constitutional amendment was agreed to by both chambers of Congress and goes on to the states.", sort_order=(3,0))
