...
bill_gpo_status_codes = {
    ...
    "eh": ("Passed the House (Engrossed)", { BillStatus.passed_simpleres, BillStatus.pass_over_house }),
    ...
    "es": ("Passed the Senate (Engrossed)", { BillStatus.passed_simpleres, BillStatus.pass_over_senate }),
