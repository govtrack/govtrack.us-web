...
# Representatives who signed onto the December 2020 Texas v Pennsylvania et al
...
def person_details(request, pk):
    def build_info():
        ...
        return {'person': person,
                ...
                'kraken_caucus': "yes" if person.id in KrakenCaucus else "no" if person.id in NTCaucus else None,
                }
