...
w.writerow(["Name", "Party", "Twitter", "Total Yes", "Total No"]
...
for voter in voters:
	...
	w.writerow([
	  voter["person_name"].encode("utf8"),
	  voter.get("party", "[Changed]"),
	  voter['person'].twitterid,
	  voter["total_plus"], voter["total_votes"]-voter["total_plus"]
	  ]
