...
urlpatterns = patterns('website.views',
    ...
    url(r'^(start|about|press|advertising|legal|developers|developers/downstream|developers/data|developers/license|developers/rsync|developers/people_xml|civicimpulse|blog_template)$', 'staticpage', name='staticpage'),
