...
urlpatterns = [
    ...
    url(r'^(start|about|about-our-data|contact|press|advertising|legal|what-is-the-law|how-a-bill-becomes-a-law|congressional-procedures|sousveillance|reading-list|how-to-use|for-hill-staff|for-advocates|for-journalists|for-educators|voterama)$', website.views.staticpage, name='staticpage'),
