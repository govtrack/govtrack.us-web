...
urlpatterns = patterns('website.views',
    ...
    url(r'^(start|about|contact|press|advertising|legal|developers|developers/downstream|developers/data|developers/license|developers/rsync|what-is-the-law|how-a-bill-becomes-a-law|sousveillance)$', 'staticpage', name='staticpage'),
