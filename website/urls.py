...
urlpatterns = patterns('website.views',
    ...
    url(r'^(overview|about|press|advertising|tools|legal|developers|developers/downstream|developers/data|developers/license|developers/rsync|developers/people_xml|developers/vote_xml|developers/bill_xml|civicimpulse|blog_template)$', 'staticpage', name='staticpage'),
