...
urlpatterns = [
    ...
    url(r'^website/_load_positions', website.views.load_positions, name='load_positions'),
    url(r'^_ajax/position', website.views.change_position, name='position'),
    url(r'^_ajax/reasons', website.views.change_reasons, name='reasons'),
