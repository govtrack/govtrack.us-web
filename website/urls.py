...
urlpatterns = patterns('website.views',
    ...
    url(r'^(start|about|contact|press|advertising|legal|developers|developers/downstream|developers/data|developers/license|developers/rsync)$', 'staticpage', name='staticpage'),
